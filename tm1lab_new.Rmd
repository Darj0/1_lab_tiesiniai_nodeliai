...
data <- data %>%
  mutate(`Kėbulo tipas` = recode(`Kėbulo tipas`,
    "COMPACT"                  = "Hečbekas",
    "SUV - SMALL"              = "Universalas (mažas visureigis)",
    "MID-SIZE"                 = "Sedanas",
    "TWO-SEATER"               = "Kupė",
    "MINICOMPACT"              = "Hečbekas (mini)",
    "SUBCOMPACT"               = "Hečbekas (subkompaktinis)",
    "FULL-SIZE"                = "Limuzinas",
    "STATION WAGON - SMALL"    = "Universalas (mažas)",
    "SUV - STANDARD"           = "Universalas (standartinis visureigis)",
    "VAN - CARGO"              = "Krovininis furgonas",
    "VAN - PASSENGER"          = "Keleivinis furgonas",
    "PICKUP TRUCK - STANDARD"  = "Pikapas (standartinis)",
    "MINIVAN"                  = "Vienatūris",
    "SPECIAL PURPOSE VEHICLE"  = "Specialios paskirties automobilis",
    "STATION WAGON - MID-SIZE" = "Universalas (vidutinio dydžio)",
    "PICKUP TRUCK - SMALL"     = "Pikapas (mažas)"
  ))
