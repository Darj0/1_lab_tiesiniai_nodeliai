...
# Logaritmuojame visus skaitinius kintamuosius 
#data[sapply(data, is.numeric)] <- lapply(data[sapply(data, is.numeric)], log)
...
# Išsaugom kaip PNG 
ggsave(filename = "/Users/darjabaranova/Desktop/scatter.png",
...
```{r}
set.seed(123)  # kad rezultatas būtų atkartojamas

# Atsitiktinai sumaišome eilutes
data <- data[sample(nrow(data)), ]

# Pasirenkame dalį duomenų testui
...
```{r}
#4.1. Nauji modeliai (išimame kuro sąnaudas mieste ir greitkelyje)
...
# 2. QQ grafikas
qqnorm(resid(model1a), pch = 20, col = "darkgreen", bg = "white",
       main = "Liekanų QQ grafikas",
       xlab = "Teoriniai kvantiliai",
       ylab = "Stebėtos liekanos")
qqline(resid(model1a), col = "red", lwd = 2)

# 3. Scale-Location
plot(fitted(model1a), sqrt(abs(rstandard(model1a))),
     pch = 20, col = "darkgreen", bg = "white",
     xlab = "Prognozuotos reikšmės",
     ylab = "√|Standartizuotos liekanos|",
     main = "Scale-Location")
lines(lowess(fitted(model1a), sqrt(abs(rstandard(model1a)))),
      col = "red", lwd = 2)

# 4. Cook's distance
plot(cooks.distance(model1a), type = "h",
     col = "darkgreen", lwd = 2,
     xlab = "Stebėjimo numeris",
     ylab = "Cook's atstumas",
     main = "Įtakingi taškai (Cook's distance)")
abline(h = 4/length(resid(model1a)), col = "red", lty = 2)
...
# 2. Cook'o atstumas
plot(cooks.distance(model1a), 
     pch = 20, col = "darkgreen", bg = "white",
     xlab = "Stebėjimo numeris", 
     ylab = "Cook's atstumas",
     main = "Įtakingi taškai (Cook's distance)")
abline(h = 4/length(resid(model1a)), col = "black", lty = 2)

# 3. Standartizuotos liekanos
plot(rstandard(model1a), 
     pch = 20, col = "darkgreen", bg = "white",
     xlab = "Stebėjimo numeris", 
     ylab = "Standartizuotos liekanos",
     main = "Standartizuotos liekanos")
...
qqnorm(residuals(model1a),
       pch = 19, col = "darkgreen", bg = "white",
       main = "Liekanų QQ grafikas",
       xlab = "Teoriniai kvantiliai",
       ylab = "Stebėtos liekanos")
qqline(residuals(model1a), col = "red", lwd = 2)
...
qqnorm(residuals(model2a),
       ...
       xlab = "Teoriniai kvantiliai",
       ylab = "Stebėtos liekanos")
qqline(residuals(model2a), col = "red", lwd = 2)

# Histograma
hist(residuals(model2a),
     breaks = 30,
     col = "darkviolet",
     border = "black",
     main = "Liekanų pasiskirstymas",
...
lines(lowess(fitted(model1a), resid(model1a)),
      col = "red", lwd = 2)
...
plot(fitted(model1a), train_data$`CO2 emisijos (g/km)`,
     xlab="Prognozuotos reikšmės", ylab="Stebėtos reikšmės",
     main="Pirmas modelis", pch=21, col="darkgreen")
